...
(function ($, Drupal, imce) {
  ...
  imce.createRenameForm = function () {
    ...
    if (!form) {
      form = imce.renameForm = imce.createEl('<form class="imce-rename-form"><div class="imce-form-item"><label>' + Drupal.t('New name') + '</label><input type="text" name="name" size="50" maxlength="200" /></div><div class="imce-form-actions"><button type="submit" name="op" class="imce-rename-button">' + Drupal.t('Rename') + '</button></div></form>');
